/** Países por grado (1º y 3º), mismos datos que usa Home */
export const COUNTRY_PAGES = {
  ...
  espana: { name: "España", flag: "https://flagcdn.com/w320/es.png" },
  "paises-bajos": { name: "Países Bajos", flag: "https://flagcdn.com/w320/nl.png" },
};

export const GRADE1_SLUGS = ["mexico", "francia", "alemania", "inglaterra"];

export const GRADE3_SLUGS = [
  "italia",
  "belgica",
  "brasil",
  "espana",
